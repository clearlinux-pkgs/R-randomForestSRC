...
Version  : 3.3.2
Release  : 23
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/randomForestSRC_3.3.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/randomForestSRC_3.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736861998
