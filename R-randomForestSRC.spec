...
Version  : 3.4.1
Release  : 26
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/randomForestSRC_3.4.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/randomForestSRC_3.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749575062
